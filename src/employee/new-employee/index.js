...
const AddEmployee = () => {
  ...
  return (
    <div className = "m-5">
      ...
      <hr></hr>
      <p> Info </p>
      <input type="text" id="fname" onChange={handleFName} value = {fName}/>
      <br />
      <br />
      <input type="text" id="lname" onChange={handleLName} value = {lName} />
      <br />
      <br />
      <input type="text" id="email" onChange={handleEmail} value = {email} />
      <br />
      <br />
      <input type="text" id="number"  onChange={handleContactNum} value = {contactNum}/>
      <br />
      <br />
      <p> Role </p>
